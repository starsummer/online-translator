...
(function(e) {
    e.fn.textify = function(t) {
        defaults = {numberOfColumn: 2, margin: 20, padding: 15, width: "screen", height: "screen", showNavigation: true, textAlign: "justify", isZoom: false};
        var n;
        ...
        return this.each(function() {
            ...
            function b(n) {
                ...
                g();
                t.startPage = 1;
                d.empty().append('<div class="textify"/>').children().css({height: c, width: l}).append('<div class="contentText"/>');
            ...
            function E() {
                r.children().css({height: c, width: l * t.startPage}).append('<div class="page' + t.startPage + '" />').children().css({height: c - t.padding * 2, width: l - t.padding * 2, padding: t.padding, "float": "left"});
